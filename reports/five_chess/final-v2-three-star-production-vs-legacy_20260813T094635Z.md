...
新三星与旧三星完成 200 局配对对抗。新三星总体战绩为 100 胜、0 和、100 负，得分率 50.0%，Wilson 95% 区间为 43.1%–56.9%。结果未显示相对旧三星的统计显著棋力提升；本轮验证的是安全随机与搜索架构不退化。
...
- 正式赛记录了 1534 次新算法落子：沿用安全旧建议 1534 次，安全门控覆盖 0 次。
...
- 原始逐局数据：`final-v2-three-star-production-vs-legacy_20260813T094635Z_raw.json`
- 汇总数据：`final-v2-three-star-production-vs-legacy_20260813T094635Z_summary.json`
